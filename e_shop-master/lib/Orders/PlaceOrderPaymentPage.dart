...
class _PaymentPageState extends State<PaymentPage> {
  ...
  Future WriteOrderDeatilsForUser(Map<String,dynamic> data) async
  {
  ...
  Future WriteOrderDeatilsForAdmin(Map<String,dynamic> data) async
  {
