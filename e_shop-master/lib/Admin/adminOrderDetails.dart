                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Align(
                        ...
                        child: Text(
                          "Ksh " +dataMap[EcommerceApp.totalAmount].toString(),
                    ...
                    FutureBuilder<QuerySnapshot>(
                      future: EcommerceApp.firestore
                          .collection("items").where("shortInfo",whereIn: dataMap[EcommerceApp.productID]).getDocuments(),
...
class AdminShippingDetails extends StatelessWidget {
        ...
        Padding(
          ...
          child: Center(
            child: InkWell(
              onTap: ()
              {
                confrimParcelShifted(context, getOrderId);
  ...
  confrimParcelShifted(BuildContext context, String mOrderId)
  {
